...
namespace WebLayer
{
    ...
    public class RestService : IRestService
    {
        ...
        {
            Pharmacy.BusinessLayer.Data.Drug d = DrugService.CreateDrug(drug.pzn, drug.name, drug.description);
        ...
        {
            Pharmacy.BusinessLayer.Data.Drug d = DrugService.GetDrug(Int32.Parse(pzn));
            DrugService.UpdateDrug(d, drug.name, drug.description, d.MinimumInventoryLevel, d.OptimalInventoryLevel);
            return Drug(pzn);
        }
